...
# 初始化模型
tool = modelTool()
model_ft, input_size = tool.initialize_model("vgg", model, num_classes)

# 模型保存路径
filename = "./runs/vgg/checkpoint.pth"
writer = SummaryWriter(log_dir="./runs/vgg/train", flush_secs=25)  # tesnsorboard 保存可视化文件
